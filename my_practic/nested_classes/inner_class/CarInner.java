...
//    }
    ...
    // Non - static только элементы может содержать. Только если final
    // - static private имеют доступ к переменным внешнего класса
    // - Чтобы создать объект Inner, всегда необходимо сначала
    //      создать сначала объект внешнего класса
