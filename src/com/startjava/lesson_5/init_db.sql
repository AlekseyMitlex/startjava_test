...
INSERT INTO Jaegers(modelName, mark, height, weight, status, origin, launch, kaijuKill)
	VALUES
		...
		('CoyoteTango',		'Mark-1',	'85.35',	'2.312',    'Worker',   	'Japan',	'2015',	'2'),
		('Apex',                'Mark-6',	'86.0',		'1.870',    'Worker',   	'Unknown',	'2035',	'0'),
		('BracerPhoenix',	'Mark-5',	'70.91',	'2.128',    'Worker',           'Japan',	'2025',	'3'),
		('BrawlerYukon',	'Mark-1',	'73.3',		'2.075',    'Destroyed',        'USA',		'2015',	'4');
